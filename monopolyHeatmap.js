...
function monoBehavior(i){
	...
	if (pieces[i][1] === 1){
		...
		//WHEN A PIECE GOES TO JAIL IT JUMPS DOWN TO HERE WHY THE FUCK THIS PROGRAM HAS BECOME POSSESSED FUSF;LASDNBFKLASDHGLFKASHDFLKAHSDKLF;ASDHLKFAHYSCGLKASDHFLKASDHBGLKASDGHLKSDHFLASDKHFALSDKJFHALKSDFHALSDKFHALSDFHAL,SDJMGHBASL,FMDNVNASLD,JGBSALJ,D
		spaces[pieces[i][0]].pieceCount++
