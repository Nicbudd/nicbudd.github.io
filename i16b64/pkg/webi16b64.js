...
* @returns {string}
*/
export function wasm_main(code, debug, stdin) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = passStringToWasm0(stdin, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        wasm.wasm_main(retptr, ptr0, len0, debug, ptr1, len1);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('webi16b64_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
